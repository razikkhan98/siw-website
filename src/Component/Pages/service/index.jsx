...
const Service = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const newShowCards = Array.from(document.querySelectorAll('.service-card')).map(card => {
  ...
  const cardData = [
    {
      image: Service1,
      title: 'Rumeno',
      describe: 'It is a long established fact that a reader will be distracted by the readable content of a page.',
    },
    {
      image: Service2,
      title: 'Rumeno',
    ...
    <section className="service" id="Service">
      <div className="container mx-auto max-w-screen-xl pt-24 pb-5">
        <div className="service-head flex items-center justify-center">
          ...
          <div className="inline-block text-4xl text-color-sherpa-blue font-semibold">Our Service</div>
          <div className="flex flex-col mx-3">
            <div className="h-1 w-7 background-color-sherpa-blue inline-block mb-2"></div>
            <div className="h-1 w-16 background-color-sherpa-blue inline-block"></div>
          </div>
        </div>
        <h1 className="text-center text-xl font-medium">We provide exclusive services for your business</h1>
